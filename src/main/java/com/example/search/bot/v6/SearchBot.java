package main.java.com.example.search.bot.v6;
import main.java.com.example.core.FileReader;
import main.java.com.example.search.bot.v6.impl.FileReaderImpl;
import main.java.com.example.search.bot.v6.impl.SearchServiceImpl;
...
public class SearchBot {
    public static void main(String[] args) throws IOException {
        ...
        SearchServiceImpl searchService = new SearchServiceImpl(fileReader,4);
